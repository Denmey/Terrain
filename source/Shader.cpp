...
namespace Trn {
	...
	void Shader::addAttribute(const GLchar* attributeName,
		                        GLint size,
		                        GLenum type,
		                        GLboolean shouldBeNormalized,
		                        GLsizei stride,
		                        const GLvoid * offset)
	{
		                        ...
		                        const std::string& geometryFile)
	{
		...
		try {
			...
			if (geometryFile != "") {
				...
				geomFStr.close();
				loadFromMemory(vertexSource  .str().c_str(),
	...
	void Shader::loadFromMemory(const GLchar* vertexSource,
